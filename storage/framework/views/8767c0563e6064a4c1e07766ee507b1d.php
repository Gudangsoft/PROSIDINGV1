<div class="p-6 max-w-5xl mx-auto">
    ...
    <div class="flex items-center gap-1 mb-6 bg-gray-100 rounded-lg p-1 w-fit">
        <button wire:click="switchLocation('header')"
            class="px-4 py-2 text-sm font-medium rounded-md transition <?php echo e($location === 'header' ? 'bg-white text-blue-700 shadow-sm' : 'text-gray-600 hover:text-gray-800'); ?>">
        ...
        <button wire:click="switchLocation('footer')"
            class="px-4 py-2 text-sm font-medium rounded-md transition <?php echo e($location === 'footer' ? 'bg-white text-blue-700 shadow-sm' : 'text-gray-600 hover:text-gray-800'); ?>">
            <span class="flex items-center gap-1.5">
            ...
            <div class="bg-white rounded-xl shadow-sm border">
                <div class="flex items-center justify-between px-5 py-4 border-b">
                    <h2 class="text-sm font-semibold text-gray-800 uppercase tracking-wider">
                        Menu <?php echo e($location === 'header' ? 'Header' : 'Footer'); ?>
                ...
                <div class="p-4">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($this->defaultMenus)): ?>
                    <div class="mb-4">
                        ...
                        <div class="space-y-0.5">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->defaultMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $defaultItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <div class="flex items-center gap-2 py-2 px-3 rounded-lg hover:bg-gray-50 transition <?php echo e(!($defaultMenuVisibility[$defaultItem['key']] ?? true) ? 'opacity-50' : ''); ?>">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center gap-2">
                                        <span class="text-sm font-medium text-gray-800 truncate"><?php echo e($defaultItem['label']); ?></span>
                                        <span class="px-1.5 py-0.5 bg-purple-100 text-purple-700 text-[10px] font-semibold rounded">BAWAAN</span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!($defaultMenuVisibility[$defaultItem['key']] ?? true)): ?>
                                        <span class="px-1.5 py-0.5 bg-gray-100 text-gray-500 text-[10px] font-semibold rounded">TERSEMBUNYI</span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <p class="text-xs text-gray-400 truncate font-mono"><?php echo e($defaultItem['url']); ?></p>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($defaultItem['conditional']): ?>
                                        <span class="text-[10px] text-amber-500 italic truncate"><?php echo e($defaultItem['conditional']); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center shrink-0">
                                    <button wire:click="toggleDefaultMenu('<?php echo e($defaultItem['key']); ?>')" 
                                        title="<?php echo e(($defaultMenuVisibility[$defaultItem['key']] ?? true) ? 'Sembunyikan' : 'Tampilkan'); ?>"
                                        class="relative inline-flex h-5 w-9 items-center rounded-full transition-colors <?php echo e(($defaultMenuVisibility[$defaultItem['key']] ?? true) ? 'bg-green-500' : 'bg-gray-300'); ?>">
                                        <span class="inline-block h-3.5 w-3.5 transform rounded-full bg-white transition-transform shadow-sm <?php echo e(($defaultMenuVisibility[$defaultItem['key']] ?? true) ? 'translate-x-4' : 'translate-x-0.5'); ?>"></span>
                                    </button>
                                </div>
                            </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->menuTree->count()): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->menuTree; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <?php echo $__env->make('livewire.admin.partials.menu-item', ['menu' => $menu, 'depth' => 0], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <?php else: ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border sticky top-20">
                <div class="flex items-center justify-between px-5 py-4 border-b">
                    <h3 class="text-sm font-semibold text-gray-800">
                        <?php echo e($editingId ? 'Edit Menu' : 'Tambah Menu'); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <select wire:model="parent_id" class="w-full border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->availableParents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <option value="<?php echo e($p->id); ?>">
                                    <?php echo e(str_repeat('— ', $p->depth)); ?><?php echo e($p->title); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="flex gap-2 pt-2">
                        <button type="submit" class="flex-1 px-4 py-2.5 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition flex items-center justify-center gap-2">
                            ...
                            <?php echo e($editingId ? 'Perbarui' : 'Simpan'); ?>
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\livewire\admin\menu-manager.blade.php ENDPATH**/ ?>
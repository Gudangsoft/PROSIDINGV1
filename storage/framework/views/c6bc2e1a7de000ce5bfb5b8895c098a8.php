...
<head>
    ...
    <title>Publikasi - <?php echo e($siteName); ?></title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
            ...
            <div class="mt-8 flex justify-center gap-8">
                <div class="text-center">
                    <p class="text-3xl font-extrabold"><?php echo e($totalPapers); ?></p>
                    <p class="text-blue-200 text-sm">Total Paper</p>
                </div>
                <div class="text-center">
                    <p class="text-3xl font-extrabold"><?php echo e($totalConferences); ?></p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex-1">
            ...
            <div class="bg-white rounded-2xl shadow-sm border overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 md:p-8 text-white">
                    <div class="flex flex-col md:flex-row gap-6 items-start">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentConference->cover_image): ?>
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(asset('storage/' . $currentConference->cover_image)); ?>" alt="<?php echo e($currentConference->name); ?>" class="w-36 h-48 object-cover rounded-xl shadow-lg border-2 border-white/20">
                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <div class="flex-1 min-w-0">
                            ...
                            <h3 class="text-2xl md:text-3xl font-extrabold leading-tight"><?php echo e($currentConference->name); ?></h3>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentConference->theme): ?>
                            <p class="text-blue-100 mt-2 text-sm md:text-base italic">"<?php echo e($currentConference->theme); ?>"</p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <div class="flex flex-wrap gap-4 mt-4 text-sm text-blue-100">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentConference->start_date): ?>
                                <div class="flex items-center gap-1.5">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                                    <?php echo e($currentConference->date_range); ?>

                                </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <div class="flex items-center gap-1.5">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e(\App\Models\Conference::VENUE_TYPE_ICONS[$currentConference->venue_type ?? 'offline'] ?? ''); ?>"/></svg>
                                    <span class="bg-white/15 px-1.5 py-0.5 rounded text-xs font-medium"><?php echo e($currentConference->venue_type_label); ?></span>
                                    <?php echo e($currentConference->venue_display); ?>

                                </div>
                                <div class="flex items-center gap-1.5">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                                    <?php echo e($currentPapers->count()); ?> Paper
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="divide-y divide-gray-100">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $currentPapers->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paper): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <div class="px-6 md:px-8 py-5 hover:bg-blue-50/30 transition">
                        <div class="flex items-start gap-4">
                            <div class="flex-1 min-w-0">
                                <h5 class="text-base font-bold text-gray-800 leading-snug"><?php echo e($paper->title); ?></h5>
                                <div class="flex items-center gap-1.5 mt-1.5 text-sm text-gray-500">
                                    ...
                                    <span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paper->authors_meta && count($paper->authors_meta)): ?>
                                            <?php echo e(collect($paper->authors_meta)->pluck('name')->join(', ')); ?>

                                        <?php else: ?>
                                            <?php echo e($paper->user->name); ?>
                                ...
                                <div class="flex flex-wrap items-center gap-2 mt-2">
                                    ...
                                    <span class="inline-flex items-center text-xs bg-blue-50 text-blue-700 px-2 py-0.5 rounded-full font-medium"><?php echo e($paper->topic); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <span class="text-xs text-gray-400"><?php echo e($paper->accepted_at->format('d M Y')); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                ...
                                <div x-data="{ open: false }" class="mt-2">
                                    ...
                                    <div x-show="open" x-cloak x-transition class="mt-2 text-sm text-gray-600 bg-gray-50 rounded-lg p-4 leading-relaxed"><?php echo e($paper->abstract); ?></div>
                                </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>

                            <?php $fullPaper = $paper->files->whereIn('type', ['full_paper', 'revision'])->sortByDesc('created_at')->first(); ?>
                            ...
                            <div class="flex-shrink-0">
                                <a href="<?php echo e(asset('storage/' . $fullPaper->file_path)); ?>" target="_blank"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentPapers->count() > 0): ?>
                <div class="px-6 md:px-8 py-4 bg-gray-50 border-t text-center">
                    <a href="<?php echo e(route('proceedings.show', $currentConference)); ?>" class="text-sm text-blue-600 hover:text-blue-800 font-semibold inline-flex items-center gap-1">
                        Lihat Semua Paper (<?php echo e($currentPapers->count()); ?>)
        ...
        <section class="mb-12">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <a href="<?php echo e(route('proceedings.show', $conf)); ?>" class="bg-white rounded-xl shadow-sm border hover:shadow-md hover:border-blue-200 transition group overflow-hidden">
                    ...
                    <div class="h-40 overflow-hidden">
                        <img src="<?php echo e(asset('storage/' . $conf->cover_image)); ?>" alt="<?php echo e($conf->name); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">
                    </div>
                    <?php else: ?>
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <div class="p-5">
                        <h3 class="font-bold text-gray-800 group-hover:text-blue-700 transition leading-snug"><?php echo e($conf->name); ?></h3>
                        ...
                        <p class="text-xs text-gray-500 italic mt-1 line-clamp-2">"<?php echo e($conf->theme); ?>"</p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <div class="flex flex-wrap gap-3 mt-3 text-xs text-gray-400">
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                <?php echo e($conf->date_range); ?>

                            </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <div class="flex items-center gap-1">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                                <?php echo e($conf->completed_papers_count); ?> Paper
                            </div>
                        </div>
                    </div>
                </a>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$currentConference && $pastConferences->count() === 0 && $unassignedPapers->count() === 0): ?>
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\templates\default-blue\proceedings.blade.php ENDPATH**/ ?>
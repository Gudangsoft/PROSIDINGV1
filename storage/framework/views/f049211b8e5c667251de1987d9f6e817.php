              ...
              <td style="padding:18px 20px;">
                ...
                <table width="100%" cellpadding="6" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td style="font-size:20px;font-weight:800;color:#d97706;padding-top:10px;"><?php echo e($amount); ?></td>
                  </tr>
                </table>
              </td>
            </tr>
          ...
          <table width="100%" cellpadding="4" cellspacing="0" style="margin-bottom:28px;">
            ...
            <tr>
              <td width="36" style="vertical-align:top;padding-top:4px;">
                <span style="display:inline-block;background:#d97706;color:#fff;border-radius:50%;width:22px;height:22px;text-align:center;font-size:12px;font-weight:700;line-height:22px;"><?php echo e($s['num']); ?></span>
              </td>
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\emails\payment-reminder.blade.php ENDPATH**/ ?>
...
<head>
    ...
    ?>
    <title><?php echo $__env->yieldContent('title', $__siteTitle); ?></title>
    ...
    <div class="flex min-h-screen">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="flex items-center justify-between h-16 px-5 border-b border-gray-200 shrink-0">
                <?php
                    $adminSiteLogoUrl = \App\Models\Setting::getLogoUrl();
                ...
                <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-2.5 min-w-0">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($adminSiteLogoUrl): ?>
                        <img src="<?php echo e($adminSiteLogoUrl); ?>" alt="<?php echo e($adminSiteName); ?>" class="h-8 w-8 object-contain rounded-lg shrink-0">
                    <?php else: ?>
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
                ...
                <a href="<?php echo e(route('notifications')); ?>"
                   ...
                   <?php echo e(request()->routeIs('notifications') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sidebarUnreadCount > 0): ?>
                        <span class="bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded-full"><?php echo e($sidebarUnreadCount > 99 ? '99+' : $sidebarUnreadCount); ?></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </a>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(\Illuminate\Support\Facades\Route::has('manual')): ?>
                <a href="<?php echo e(route('manual')); ?>"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                   <?php echo e(request()->routeIs('manual') ? 'bg-green-50 text-green-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
                ...
                <div class="pt-4">
                    ...
                    <a href="<?php echo e(route('author.submit')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('author.submit') ? 'bg-green-50 text-green-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
                    ...
                    <a href="<?php echo e(route('author.loa')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('author.loa') ? 'bg-purple-50 text-purple-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
                        LOA & Tagihan
                    </a>
                    <a href="<?php echo e(route('author.video')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('author.video') ? 'bg-red-50 text-red-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
                    ...
                    <a href="<?php echo e(route('author.certificates')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('author.certificates') ? 'bg-amber-50 text-amber-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->isReviewer() || Auth::user()->isEditor() || Auth::user()->isAdmin()): ?>
                <div class="pt-4">
                ...
                <div class="pt-4">
                    ...
                    <a href="<?php echo e(route('participant.info')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('participant.info') ? 'bg-teal-50 text-teal-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                        My Information
                    </a>
                    <a href="<?php echo e(route('participant.payment')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('participant.payment') ? 'bg-teal-50 text-teal-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
                    ...
                    <a href="<?php echo e(route('participant.materials')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('participant.materials') ? 'bg-teal-50 text-teal-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->isKeuangan()): ?>
                <div class="pt-4">
                    <p class="px-3 mb-2 text-xs font-semibold text-gray-400 uppercase tracking-wider">Keuangan</p>
                    <a href="<?php echo e(route('keuangan.payments')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('keuangan.payments') ? 'bg-emerald-50 text-emerald-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
                ...
                <div class="pt-4">
                    ...
                    <a href="<?php echo e(route('admin.tutorials')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition
                       <?php echo e(request()->routeIs('admin.tutorials*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
                        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                        Tutorial
                    </a>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(\Illuminate\Support\Facades\Route::has('admin.certificates')): ?>
                ...
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <div class="min-w-0">
                        ...
                        <span class="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-semibold
                            ...
                            <?php elseif(Auth::user()->role==='keuangan'): ?> bg-emerald-100 text-emerald-700
            ...
            <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 lg:px-6 shrink-0">
                <div class="flex items-center gap-3">
                    ...
                    <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-2 lg:hidden">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(\App\Models\Setting::getLogoUrl()): ?>
                            <img src="<?php echo e(\App\Models\Setting::getLogoUrl()); ?>" alt="Logo" class="h-8 w-8 object-contain rounded-lg">
                        <?php else: ?>
                    ...
                    <div class="relative" x-data="notificationDropdown()">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" class="absolute right-0 mt-2 w-96 bg-white rounded-lg shadow-xl border border-gray-200 z-50" style="display: none;">
                            ...
                            <div class="p-3 border-t border-gray-200 bg-gray-50">
                                <a href="<?php echo e(route('notifications')); ?>" class="flex items-center justify-center gap-2 text-sm font-medium text-blue-600 hover:text-blue-800 transition">
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views/layouts/app.blade.php ENDPATH**/ ?>
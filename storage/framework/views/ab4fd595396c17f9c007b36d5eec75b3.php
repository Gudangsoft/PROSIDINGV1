<div class="p-6 max-w-5xl mx-auto">
    ...
    <div class="flex items-center gap-2 mb-6">
        <button wire:click="$set('filterType', '')" class="px-3 py-1.5 text-xs font-medium rounded-lg transition <?php echo e(!$filterType ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'); ?>">Semua</button>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = \App\Models\Supporter::TYPE_LABELS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
        <button wire:click="$set('filterType', '<?php echo e($key); ?>')" class="px-3 py-1.5 text-xs font-medium rounded-lg transition <?php echo e($filterType === $key ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'); ?>"><?php echo e($label); ?></button>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $supporters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supporter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <div class="bg-white rounded-xl shadow-sm border p-4 group <?php echo e(!$supporter->is_active ? 'opacity-50' : ''); ?>">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="w-16 h-16 rounded-xl bg-gray-50 border flex items-center justify-center overflow-hidden shrink-0">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($supporter->logo): ?>
                                <img src="<?php echo e(asset('storage/' . $supporter->logo)); ?>" alt="<?php echo e($supporter->name); ?>" class="max-w-full max-h-full object-contain p-1">
                            <?php else: ?>
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-sm font-bold text-gray-800 truncate"><?php echo e($supporter->name); ?></h3>
                            <span class="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-semibold mt-0.5
                                <?php echo e($supporter->type === 'supporter' ? 'bg-blue-100 text-blue-700' : ''); ?>

                                <?php echo e($supporter->type === 'sponsor' ? 'bg-green-100 text-green-700' : ''); ?>

                                <?php echo e($supporter->type === 'partner' ? 'bg-purple-100 text-purple-700' : ''); ?>

                                <?php echo e($supporter->type === 'organizer' ? 'bg-orange-100 text-orange-700' : ''); ?>">
                                <?php echo e($supporter->type_label); ?>
                            ...
                            <p class="text-xs text-gray-400 truncate mt-0.5"><?php echo e($supporter->url); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>

                        
                        <div class="flex gap-1 opacity-0 group-hover:opacity-100 transition shrink-0">
                            <button wire:click="toggleActive(<?php echo e($supporter->id); ?>)" title="<?php echo e($supporter->is_active ? 'Nonaktifkan' : 'Aktifkan'); ?>"
                                class="p-1.5 rounded transition <?php echo e($supporter->is_active ? 'text-green-500 hover:bg-green-50' : 'text-gray-400 hover:bg-gray-100'); ?>">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                            </button>
                            <button wire:click="edit(<?php echo e($supporter->id); ?>)" title="Edit" class="p-1.5 text-gray-400 hover:text-amber-600 hover:bg-amber-50 rounded transition">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                            </button>
                            <button wire:click="delete(<?php echo e($supporter->id); ?>)" wire:confirm="Hapus '<?php echo e($supporter->name); ?>'?" title="Hapus" class="p-1.5 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded transition">
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-white rounded-xl shadow-sm border sticky top-20">
                <div class="flex items-center justify-between px-5 py-4 border-b">
                    <h3 class="text-sm font-semibold text-gray-800"><?php echo e($editingId ? 'Edit Supporter' : 'Tambah Supporter'); ?></h3>
                        ...
                        <div class="border-2 border-dashed border-gray-200 rounded-xl p-4 text-center">
                            <div class="w-20 h-20 mx-auto bg-gray-50 rounded-xl flex items-center justify-center overflow-hidden mb-3 border">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logo): ?>
                                    <img src="<?php echo e($logo->temporaryUrl()); ?>" class="max-w-full max-h-full object-contain">
                                <?php elseif($existingLogo): ?>
                                    <img src="<?php echo e(asset('storage/' . $existingLogo)); ?>" class="max-w-full max-h-full object-contain">
                                <?php else: ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($existingLogo): ?>
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\livewire\admin\supporter-manager.blade.php ENDPATH**/ ?>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-14">
                ...
                <div class="inline-flex items-center gap-2 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-2xl px-6 py-3 mt-2">
                    ...
                    <p class="text-base text-blue-700 font-semibold italic"><?php echo e($activeConference->theme); ?></p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
                ...
                <div class="lg:col-span-5 order-2 lg:order-1">
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                        <div class="flex items-center gap-2 mb-4">
                            ...
                            <h3 class="text-sm font-bold text-gray-700 uppercase tracking-wider"><?php echo e(__('welcome.conference.topik_bidang')); ?></h3>
                            <span class="ml-auto text-xs font-bold bg-indigo-100 text-indigo-600 px-2 py-0.5 rounded-full"><?php echo e($activeConference->topics->count()); ?></span>
                        </div>
                        <div class="grid grid-cols-2 gap-x-3 gap-y-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $activeConference->topics->sortBy('sort_order'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <?php
                            ...
                            <div class="flex items-start gap-2 group">
                                <span class="shrink-0 w-5 h-5 rounded-md <?php echo e($nc); ?> text-[10px] font-extrabold flex items-center justify-center mt-0.5"><?php echo e($i + 1); ?></span>
                                <span class="text-xs text-gray-700 font-medium leading-snug group-hover:text-indigo-700 transition-colors"><?php echo e($topic->name); ?></span>
                            </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasPoster): ?>
                ...
                <div class="<?php echo e($hasPoster ? 'lg:col-span-3' : 'lg:col-span-7'); ?> order-3">
                        ...
                        <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
                            <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-5 py-4">
                                <h3 class="text-sm font-bold text-white uppercase tracking-wider flex items-center gap-2">
                                    ...
                                    <?php echo e(__('welcome.conference.info_kegiatan')); ?>
                            ...
                            <div class="p-5 space-y-4">
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p class="text-xs font-bold text-gray-400 uppercase tracking-wider"><?php echo e(__('welcome.conference.tanggal')); ?></p>
                                        ...
                                        <p class="text-xs text-gray-400 mt-0.5"><?php echo e($activeConference->formatted_time); ?></p>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php $vColor = ['offline'=>'bg-green-50 border-green-100','online'=>'bg-sky-50 border-sky-100','hybrid'=>'bg-purple-50 border-purple-100'][$activeConference->venue_type ?? 'offline'] ?? 'bg-gray-50 border-gray-100'; ?>
                                <div class="flex items-start gap-3">
                                    <div class="w-9 h-9 <?php echo e($vColor); ?> rounded-xl flex items-center justify-center shrink-0 border">
                                        <svg class="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e(\App\Models\Conference::VENUE_TYPE_ICONS[$activeConference->venue_type ?? 'offline'] ?? ''); ?>"/></svg>
                                    </div>
                                    <div>
                                        <p class="text-xs font-bold text-gray-400 uppercase tracking-wider"><?php echo e(__('welcome.conference.lokasi')); ?></p>
                                        <p class="text-sm font-bold text-gray-800 mt-0.5"><?php echo e($activeConference->venue_type_label); ?></p>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeConference->venue_display): ?>
                                        <p class="text-xs text-gray-500 mt-0.5"><?php echo e($activeConference->venue_display); ?></p>
                                        <?php elseif($activeConference->venue_type === 'online'): ?>
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p class="text-xs font-bold text-gray-400 uppercase tracking-wider"><?php echo e(__('welcome.conference.penyelenggara')); ?></p>
                                        <p class="text-sm font-bold text-gray-800 mt-0.5"><?php echo e($activeConference->organizer); ?></p>
                                    </div>
                                </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paperCount || $topicCount || $speakerCount || $packageCount): ?>
            <div class="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paperCount): ?>
                <div class="bg-gradient-to-br from-blue-50 to-blue-100/60 border border-blue-200/60 rounded-2xl p-5 text-center hover:shadow-md transition-shadow group">
                    <div class="text-3xl font-extrabold text-blue-700 mb-1 group-hover:scale-110 transition-transform inline-block"><?php echo e(number_format($paperCount)); ?></div>
                    <div class="text-xs font-bold text-blue-500 uppercase tracking-wider">Paper Submitted</div>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($topicCount): ?>
                <div class="bg-gradient-to-br from-indigo-50 to-indigo-100/60 border border-indigo-200/60 rounded-2xl p-5 text-center hover:shadow-md transition-shadow group">
                    <div class="text-3xl font-extrabold text-indigo-700 mb-1 group-hover:scale-110 transition-transform inline-block"><?php echo e($topicCount); ?></div>
                    <div class="text-xs font-bold text-indigo-500 uppercase tracking-wider">Topik Bidang</div>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($speakerCount): ?>
                <div class="bg-gradient-to-br from-violet-50 to-violet-100/60 border border-violet-200/60 rounded-2xl p-5 text-center hover:shadow-md transition-shadow group">
                    <div class="text-3xl font-extrabold text-violet-700 mb-1 group-hover:scale-110 transition-transform inline-block"><?php echo e($speakerCount); ?></div>
                    <div class="text-xs font-bold text-violet-500 uppercase tracking-wider">Keynote Speaker</div>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($packageCount): ?>
                <div class="bg-gradient-to-br from-cyan-50 to-cyan-100/60 border border-cyan-200/60 rounded-2xl p-5 text-center hover:shadow-md transition-shadow group">
                    <div class="text-3xl font-extrabold text-cyan-700 mb-1 group-hover:scale-110 transition-transform inline-block"><?php echo e($packageCount); ?></div>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views/templates/default/sections/about.blade.php ENDPATH**/ ?>
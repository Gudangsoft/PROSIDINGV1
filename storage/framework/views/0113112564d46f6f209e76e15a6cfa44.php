...
<head>
    ...
    <title>Certificate Verification – <?php echo e($code); ?></title>
...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl max-w-lg w-full overflow-hidden">
        ...
        <div class="bg-gradient-to-r <?php echo e($certificate ? 'from-blue-800 to-indigo-700' : 'from-red-700 to-red-600'); ?> px-8 py-6 text-center">
            ...
            <h1 class="text-2xl font-bold text-white tracking-wide">
                <?php echo e($certificate ? 'Certificate Valid ✓' : 'Certificate Not Found'); ?>

            </h1>
            <p class="<?php echo e($certificate ? 'text-blue-200' : 'text-red-200'); ?> text-sm mt-1">
                <?php echo e($certificate ? 'Official Authenticity Check' : 'Pemeriksaan Keaslian Resmi'); ?>
        ...
        <div class="px-8 py-6">
            ...
            <div class="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 mb-5">
                ...
                <code class="ml-auto font-mono text-sm bg-white border border-gray-200 px-2 py-0.5 rounded text-blue-800 font-bold"><?php echo e($code); ?></code>
            </div>
            ...
            <div class="border border-gray-100 rounded-xl divide-y divide-gray-100 mb-5 text-sm">
                <div class="flex items-center px-4 py-3">
                    ...
                    <span class="font-semibold text-gray-800"><?php echo e($certificate->user->name ?? '-'); ?></span>
                </div>
                <div class="flex items-center px-4 py-3">
                    <span class="text-gray-500 w-36 shrink-0">Certificate Type</span>
                    <span class="text-gray-700"><?php echo e($certificate->getTypeLabel()); ?></span>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($certificate->paper): ?>
                <div class="flex items-start px-4 py-3">
                    <span class="text-gray-500 w-36 shrink-0 pt-0.5">Paper Title</span>
                    <span class="text-gray-700"><?php echo e($certificate->paper->title); ?></span>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($certificate->conference): ?>
                <div class="flex items-center px-4 py-3">
                    <span class="text-gray-500 w-36 shrink-0">Event</span>
                    <span class="text-gray-700"><?php echo e($certificate->conference->name); ?></span>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <div class="flex items-center px-4 py-3">
                    <span class="text-gray-500 w-36 shrink-0">Issued on</span>
                    <span class="text-gray-700"><?php echo e(($certificate->generated_at ?? $certificate->created_at)->format('d F Y')); ?></span>
                </div>
            </div>
            ...
            <div class="flex items-start gap-3 bg-red-50 border border-red-200 rounded-xl p-4 mb-5">
                ...
                <div>
                    ...
                    <p class="text-red-700 text-xs mt-0.5">
                        Nomor sertifikat <code class="font-mono bg-red-100 px-1 rounded"><?php echo e($code); ?></code>
            ...
            <div class="pt-4 border-t border-gray-100 flex items-center justify-between">
                <p class="text-xs text-gray-400">Verified at <?php echo e(now()->format('d F Y, h:i A')); ?> UTC</p>
                <a href="<?php echo e(url('/')); ?>" class="text-xs text-blue-600 hover:text-blue-800 font-medium hover:underline">
                    ← Back to Home
                </a>
            </div>
        </div>
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\verify\certificate.blade.php ENDPATH**/ ?>
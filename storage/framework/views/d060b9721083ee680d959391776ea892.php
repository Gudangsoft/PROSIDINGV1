<div class="py-6 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
    ...
    <a href="<?php echo e(route('helpdesk')); ?>" class="inline-flex items-center text-sm text-gray-500 hover:text-gray-700 mb-4">
    ...
    <div class="bg-white rounded-xl shadow-sm border p-6 mb-6">
        <div class="flex items-start justify-between mb-4">
            <div>
                <h1 class="text-xl font-bold text-gray-800"><?php echo e($ticket->subject); ?></h1>
                <div class="flex items-center gap-3 mt-2 text-sm">
                    ...
                    <span class="text-gray-400"><?php echo e($ticket->created_at->format('d M Y h:i A')); ?></span>
                </div>
            </div>
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\livewire\author\helpdesk-detail.blade.php ENDPATH**/ ?>
    ...
    <div class="bg-white border-b">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 py-3">
            <div class="flex items-center gap-2 text-sm text-gray-400">
                <a href="<?php echo e(url('/')); ?>" class="hover:text-teal-600 transition"><?php echo e(__('welcome.nav.beranda')); ?></a>
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                <span class="text-gray-600"><?php echo e(__('welcome.news.badge')); ?></span>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <article class="lg:col-span-2">
                ...
                <div class="rounded-2xl overflow-hidden mb-8 shadow-sm">
                    <img src="<?php echo e(asset('storage/' . $news->cover_image)); ?>" alt="<?php echo e($news->title); ?>" class="w-full h-auto max-h-[400px] object-cover">
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="flex flex-wrap items-center gap-3 mb-5">
                    ...
                    <span class="bg-teal-100 text-teal-700 text-xs font-bold px-2.5 py-1 rounded-full uppercase tracking-wider"><?php echo e($news->category); ?></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <span class="text-xs text-gray-400 flex items-center gap-1">
                        ...
                        <?php echo e($news->author->name ?? $news->author); ?>
                ...
                <h1 class="text-2xl md:text-3xl font-extrabold text-gray-900 mb-8 leading-tight"><?php echo e($news->title); ?></h1>
                ...
                <div class="mt-10 pt-6 border-t border-gray-200">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(request()->url())); ?>&text=<?php echo e(urlencode($news->title)); ?>" target="_blank"
                        ...
                        <a href="https://wa.me/?text=<?php echo e(urlencode($news->title . ' ' . request()->url())); ?>" target="_blank"
            ...
            <aside class="space-y-8">
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="<?php echo e(route('news.detail', $related->slug)); ?>" class="group flex items-start gap-3 p-3 bg-white rounded-xl border hover:shadow-sm hover:border-teal-200 transition">
                            ...
                            <img src="<?php echo e(asset('storage/' . $related->cover_image)); ?>" class="w-16 h-16 rounded-lg object-cover shrink-0" alt="">
                            <?php else: ?>
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <div class="min-w-0">
                                <h4 class="text-xs font-bold text-gray-800 group-hover:text-teal-700 transition line-clamp-2 mb-1"><?php echo e($related->title); ?></h4>
                                <p class="text-[10px] text-gray-400"><?php echo e($related->published_at?->translatedFormat('d M Y')); ?></p>
                            </div>
                        </a>
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="<?php echo e(route('news.detail', $latest->slug)); ?>" class="group flex items-start gap-3 p-3 bg-white rounded-xl border hover:shadow-sm hover:border-teal-200 transition">
                            ...
                            <img src="<?php echo e(asset('storage/' . $latest->cover_image)); ?>" class="w-16 h-16 rounded-lg object-cover shrink-0" alt="">
                            <?php else: ?>
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <div class="min-w-0">
                                <h4 class="text-xs font-bold text-gray-800 group-hover:text-teal-700 transition line-clamp-2 mb-1"><?php echo e($latest->title); ?></h4>
                                <p class="text-[10px] text-gray-400"><?php echo e($latest->published_at?->translatedFormat('d M Y')); ?></p>
                            </div>
                        </a>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\templates\ijo-muhammadiyah\news-detail.blade.php ENDPATH**/ ?>
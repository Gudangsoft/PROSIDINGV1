...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border overflow-hidden">
        ...
        <div class="divide-y">
            ...
            <a href="<?php echo e(route('helpdesk.detail', $ticket)); ?>" class="block px-6 py-4 hover:bg-gray-50 transition">
                <div class="flex items-start justify-between">
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-2 mb-1">
                            <h3 class="text-sm font-semibold text-gray-800 truncate"><?php echo e($ticket->subject); ?></h3>
                        ...
                        <p class="text-sm text-gray-500 truncate"><?php echo e(Str::limit(strip_tags($ticket->message), 80)); ?></p>
                        <div class="flex items-center gap-3 mt-2 text-xs text-gray-400">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->replies_count > 0): ?>
                            <span class="inline-flex items-center gap-1">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>
                                <?php echo e($ticket->replies_count); ?> balasan
                            </span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
        ...
        <div class="px-6 py-3 border-t"><?php echo e($tickets->links()); ?></div>
        <?php else: ?>
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\livewire\author\helpdesk.blade.php ENDPATH**/ ?>
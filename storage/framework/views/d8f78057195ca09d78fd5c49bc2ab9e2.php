<div class="max-w-5xl mx-auto py-8 px-4">
    <div class="mb-6">
        ...
        <div class="flex items-center gap-3 mt-2">
            ...
            <span class="text-sm text-gray-500">Disubmit: <?php echo e($paper->submitted_at?->format('d M Y h:i A')); ?></span>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border p-6">
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div>
                        ...
                        <p class="text-gray-800 mt-1 whitespace-pre-line break-words"><?php echo e($paper->abstract); ?></p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-400"><?php echo e(ucfirst(str_replace('_', ' ', $file->type))); ?> &bull; <?php echo e($file->file_size_human); ?> &bull; <?php echo e($file->created_at->format('d M Y h:i A')); ?></p>
                    ...
                    <div class="border rounded-lg p-4">
                        <div class="flex justify-between items-start mb-3">
                            <div>
                                ...
                                <p class="text-xs text-gray-400"><?php echo e($review->reviewed_at?->format('d M Y h:i A')); ?></p>
                            </div>
            ...
            <div class="bg-green-50 border border-green-200 rounded-xl p-6">
                ...
                <a href="<?php echo e($paper->loa_url); ?>" target="_blank" rel="noopener noreferrer"
                ...
                <div class="mt-4 pt-4 border-t border-green-200">
                    ...
                    <div class="grid grid-cols-2 gap-3 text-sm">
                        <div>
                            ...
                            <p class="font-mono font-medium text-green-800"><?php echo e($paper->payment->invoice_number); ?></p>
                        </div>
                        <div>
                            <span class="text-green-600 text-xs">Jumlah:</span>
                            <p class="font-bold text-green-800 text-lg"><?php echo e($paper->payment->formatted_amount); ?></p>
                        </div>
                    </div>
                    ...
                    ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pdBankName || $pdBankAccount): ?>
                    <div class="mt-3 bg-blue-50 border border-blue-200 rounded-lg p-3">
                        ...
                        <div class="text-xs space-y-0.5">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pdBankName): ?><p class="text-gray-700">Bank: <span class="font-medium"><?php echo e($pdBankName); ?></span></p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pdBankAccount): ?><p class="text-gray-700">No. Rekening: <span class="font-mono font-bold text-gray-900"><?php echo e($pdBankAccount); ?></span></p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pdAccountHolder): ?><p class="text-gray-700">a.n. <span class="font-medium"><?php echo e($pdAccountHolder); ?></span></p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pdInstructions): ?>
                        <p class="text-[10px] text-blue-600 mt-1.5 italic"><?php echo e($pdInstructions); ?></p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($paper->payment->status, ['pending', 'rejected'])): ?>
                    <a href="<?php echo e(route('author.paper.payment', $paper)); ?>" class="inline-flex items-center gap-2 mt-3 bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400 mt-0.5">Dikirim: <?php echo e($deliverable->sent_at?->format('d M Y h:i A')); ?></p>
                                </div>
                            </div>
            ...
            <div id="video-section" class="bg-white rounded-xl shadow-sm border p-6">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border">
                        ...
                        <a href="<?php echo e($videoUrlRaw); ?>" target="_blank" rel="noopener noreferrer" class="text-blue-600 hover:underline text-sm truncate"><?php echo e($videoUrlRaw); ?></a>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <form wire:submit="submitVideoUrl" class="space-y-3">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">
                            <?php echo e($paper->video_presentation_url ? 'Ganti Link Video' : 'Submit Link Video'); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <button type="submit"
                        ...
                        <span wire:loading.remove wire:target="submitVideoUrl">
                            ...
                            <?php echo e($paper->video_presentation_url ? 'Perbarui Video' : 'Submit Video'); ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border p-6">
                ...
                <div class="space-y-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        ...
                        ?>
                        <div class="flex items-center gap-3">
                            <div class="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold <?php echo e($done ? 'bg-green-500 text-white' : 'bg-gray-200 text-gray-500'); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($done): ?> ✓ <?php else: ?> <?php echo e($idx+1); ?> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <span class="text-sm <?php echo e($done ? 'text-green-700 font-medium' : 'text-gray-500'); ?>"><?php echo e($step['label']); ?></span>
                        </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
            </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center justify-between p-3 bg-white rounded-lg border border-orange-200">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-gray-800"><?php echo e($file->original_name); ?></p>
                                    <p class="text-xs text-gray-500"><?php echo e($file->file_size_human); ?> &bull; <?php echo e($file->created_at->format('d M Y h:i A')); ?></p>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($paper->status, ['payment_verified','deliverables_pending','completed'])): ?>
                        <a href="#video-section"
                           ...
                           class="flex items-center justify-center gap-2 w-full text-center bg-red-600 text-white py-2 rounded-lg hover:bg-red-700 text-sm font-medium">
                            ...
                            <?php echo e($paper->video_presentation_url ? 'Perbarui Video' : 'Submit Video Pemaparan'); ?>
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\livewire\author\paper-detail.blade.php ENDPATH**/ ?>
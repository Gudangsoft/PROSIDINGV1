    ...
    <section id="speakers" class="py-20 bg-white">
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            <div class="text-center mb-14">
                <span class="inline-block bg-teal-100 text-teal-700 text-xs font-bold px-3 py-1.5 rounded-full mb-3 uppercase tracking-wider"><?php echo e(__('welcome.speakers.badge')); ?></span>
                <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900"><?php echo e(__('welcome.speakers.title')); ?></h2>
                <p class="text-gray-400 mt-3 max-w-xl mx-auto"><?php echo e(__('welcome.speakers.description')); ?></p>
            </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $speakerTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typeKey => $typeLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <?php $filtered = $allSpeakers->where('type', $typeKey); ?>
                ...
                <div class="mb-14 last:mb-0">
                    <div class="flex items-center justify-center gap-3 mb-8">
                        ...
                        <span class="text-xs font-bold text-teal-700 bg-teal-50 px-4 py-1.5 rounded-full uppercase tracking-wider border border-teal-200"><?php echo e($typeLabel); ?></span>
                        <div class="h-px flex-1 max-w-[60px] bg-gradient-to-l from-transparent to-teal-200"></div>
                    </div>

                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-<?php echo e(min($filtered->count(), 4)); ?> gap-8 max-w-4xl mx-auto">
                        ...
                        <div class="text-center group">
                            <div class="relative w-32 h-32 mx-auto mb-4">
                                ...
                                <div class="w-32 h-32 rounded-full bg-gradient-to-br from-teal-400 to-emerald-500 flex items-center justify-center border-4 border-teal-100 group-hover:border-teal-300 transition shadow-md">
                                    <span class="text-3xl font-bold text-white"><?php echo e(strtoupper(substr($speaker->name, 0, 1))); ?></span>
                                </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <h3 class="font-bold text-gray-900"><?php echo e($speaker->name); ?></h3>
                            ...
                            <p class="text-sm text-teal-600 font-medium"><?php echo e($speaker->title); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <p class="text-xs text-gray-400 mt-0.5"><?php echo e($speaker->institution); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <span class="inline-block mt-2 bg-gray-100 text-gray-500 text-xs px-3 py-1 rounded-full"><?php echo e($speaker->topic); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\templates\ijo-muhammadiyah\sections\speakers.blade.php ENDPATH**/ ?>
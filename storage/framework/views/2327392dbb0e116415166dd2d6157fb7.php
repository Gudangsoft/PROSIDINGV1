<div class="py-6 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        ...
        <div class="flex items-center gap-3">
            ...
            <select wire:model.live="conferenceId" class="border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 min-w-[220px]">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $conferences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <option value="<?php echo e($conf->id); ?>"><?php echo e($conf->acronym ?? $conf->name); ?></option>
    ...
    <div class="flex gap-1 mb-6 border-b border-gray-200">
        ...
        <button wire:click="$set('activeTab','<?php echo e($key); ?>')"
                class="flex items-center gap-2 px-4 py-2.5 text-sm font-medium border-b-2 transition -mb-px
                       <?php echo e($activeTab === $key ? 'border-blue-600 text-blue-700' : 'border-transparent text-gray-500 hover:text-gray-700'); ?>">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['chairman_name'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <input wire:model="chairman_title" type="text" placeholder="Conference Chairperson" 
                               class="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-blue-500">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['chairman_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-500 text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <input wire:model="secretary_name" type="text" placeholder="Dr. ..." 
                               class="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-blue-500">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['secretary_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-500 text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <input wire:model="secretary_title" type="text" placeholder="Conference Secretary" 
                               class="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-blue-500">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['secretary_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-500 text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'signatures'): ?>
    <form wire:submit="saveSettings">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-xl border shadow-sm p-6">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($conference->chairman_signature): ?>
                <div class="mb-4 p-3 bg-gray-50 rounded-lg text-center border">
                    <p class="text-xs text-gray-400 mb-2">Tanda tangan saat ini:</p>
                    <img src="<?php echo e(Storage::url($conference->chairman_signature)); ?>" alt="Chairman Signature"
                ...
                <div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['chairman_signature_upload'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-500 text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($chairman_signature_upload): ?>
                <div class="mt-3 p-3 bg-blue-50 rounded-lg text-center border border-blue-100">
                    <p class="text-xs text-blue-600 mb-2">Preview:</p>
                    <img src="<?php echo e($chairman_signature_upload->temporaryUrl()); ?>" class="max-h-20 mx-auto object-contain">
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="bg-white rounded-xl border shadow-sm p-6">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($conference->secretary_signature): ?>
                <div class="mb-4 p-3 bg-gray-50 rounded-lg text-center border">
                    <p class="text-xs text-gray-400 mb-2">Tanda tangan saat ini:</p>
                    <img src="<?php echo e(Storage::url($conference->secretary_signature)); ?>" alt="Secretary Signature"
                         class="max-h-20 mx-auto object-contain">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-1">Format: PNG / JPG / transparent PNG. Maks 2MB.</p>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['secretary_signature_upload'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-500 text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($secretary_signature_upload): ?>
                <div class="mt-3 p-3 bg-indigo-50 rounded-lg text-center border border-indigo-100">
                    ...
                    <img src="<?php echo e($secretary_signature_upload->temporaryUrl()); ?>" class="max-h-20 mx-auto object-contain">
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="bg-white rounded-xl border shadow-sm p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="<?php echo e(route('admin.certificate.preview', ['conference' => $conference->id, 'type' => $previewType])); ?>"
                   target="_blank"
        ...
        <div class="border-2 border-dashed border-gray-200 rounded-xl overflow-hidden bg-gray-100">
            ...
            <iframe
                src="<?php echo e(route('admin.certificate.preview', ['conference' => $conference->id, 'type' => $previewType])); ?>"
                class="w-full"
                style="height: 560px;"
                loading="lazy">
            </iframe>
        ...
        <div class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3">
            <div class="bg-gray-50 rounded-lg p-3 border text-sm">
                ...
                <div class="text-gray-500 mt-0.5"><?php echo e($conference->chairman_name ?: '(belum diisi)'); ?></div>
                <div class="text-gray-400 text-xs"><?php echo e($conference->chairman_title ?: ''); ?></div>
            </div>
            <div class="bg-gray-50 rounded-lg p-3 border text-sm">
                <div class="font-medium text-gray-700">Sekretaris</div>
                <div class="text-gray-500 mt-0.5"><?php echo e($conference->secretary_name ?: '(belum diisi)'); ?></div>
                <div class="text-gray-400 text-xs"><?php echo e($conference->secretary_title ?: ''); ?></div>
            </div>
            <div class="bg-gray-50 rounded-lg p-3 border text-sm">
                <div class="font-medium text-gray-700">Tanda Tangan</div>
                <div class="flex gap-3 mt-1">
                    <span class="flex items-center gap-1 text-xs <?php echo e($conference->chairman_signature ? 'text-green-600' : 'text-gray-400'); ?>">
                        <span class="w-1.5 h-1.5 rounded-full <?php echo e($conference->chairman_signature ? 'bg-green-500' : 'bg-gray-300'); ?>"></span>
                        Ketua
                    </span>
                    <span class="flex items-center gap-1 text-xs <?php echo e($conference->secretary_signature ? 'text-green-600' : 'text-gray-400'); ?>">
                        <span class="w-1.5 h-1.5 rounded-full <?php echo e($conference->secretary_signature ? 'bg-green-500' : 'bg-gray-300'); ?>"></span>
                        Sekretaris
                    </span>
                </div>
            </div>
    ...
    <div class="space-y-5">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($batchStats)): ?>
        <div class="bg-green-50 border border-green-200 rounded-lg p-4 text-sm flex items-center gap-3">
            ...
            <div>
                ...
                <span class="text-green-700"> Berhasil: <?php echo e($batchStats['authors'] ?? 0); ?> sertifikat, Gagal: <?php echo e($batchStats['failed'] ?? 0); ?>.</span>
            </div>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="bg-white rounded-xl border shadow-sm">
            <div class="px-5 py-4 border-b flex items-center gap-3">
                ...
                <span class="text-sm text-gray-500"><?php echo e($certificates->count()); ?> sertifikat ditemukan</span>
            </div>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3">
                                <div class="font-medium text-gray-800"><?php echo e($cert->user->name ?? '—'); ?></div>
                                <div class="text-xs text-gray-400"><?php echo e($cert->user->email ?? ''); ?></div>
                            </td>
                            <td class="px-4 py-3 text-gray-600 max-w-xs truncate">
                                <?php echo e($cert->paper->title ?? '—'); ?>

                            </td>
                            <td class="px-4 py-3 text-gray-500">
                                <?php echo e($cert->sent_at?->format('d/m/Y') ?? '—'); ?>
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\livewire\admin\certificate-manager.blade.php ENDPATH**/ ?>
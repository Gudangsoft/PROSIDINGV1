...
<head>
    ...
    <title>Buku Panduan <?php echo e($rc['emoji']); ?> <?php echo e($rc['label']); ?> — <?php echo e($siteName); ?></title>
...
<div class="no-print sticky top-0 bg-white border-b border-gray-200 shadow-sm z-50 px-6 py-3 flex items-center justify-between">
    <div class="flex items-center gap-3">
        <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-2 text-blue-600 hover:text-blue-800 text-sm font-medium">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/></svg>
            Kembali ke Dashboard
        </a>
        <span class="text-gray-300">|</span>
        <span class="text-sm font-semibold text-gray-700">📖 Buku Panduan — <?php echo e($rc['emoji']); ?> <?php echo e($rc['label']); ?></span>
    </div>
...
<div class="bg-gradient-to-br <?php echo e($rc['grad']); ?> rounded-2xl text-white px-10 py-16 mb-10 text-center shadow-xl">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($siteLogo): ?>
    <img src="<?php echo e(asset('storage/'.$siteLogo)); ?>" alt="Logo" class="h-20 w-20 object-contain rounded-2xl mx-auto mb-6 bg-white/20 p-2">
    <?php else: ?>
    ...
    <h1 class="text-4xl font-black mb-3"><?php echo e($siteName); ?></h1>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeConf): ?>
    <p class="text-white/80 text-lg font-medium mb-1"><?php echo e($activeConf->title); ?></p>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <div class="mt-6 inline-flex items-center gap-2 bg-white/20 px-5 py-2 rounded-full text-lg font-bold">
        <?php echo e($rc['emoji']); ?> Panduan untuk: <?php echo e($rc['label']); ?>

    </div>
    <div class="mt-3 text-white/60 text-sm">Login sebagai: <strong class="text-white"><?php echo e(Auth::user()->name); ?></strong></div>
    <p class="text-white/50 text-xs mt-6"><?php echo e(url('/')); ?> &nbsp;|  Dicetak: <?php echo e(now()->isoFormat('D MMMM Y')); ?></p>
</div>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 px-8 py-7 mb-8">
    ...
    <div class="space-y-1 text-sm">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isAuthor): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPart): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isRev): ?>
        ...
        <a href="#sec-admin" class="toc-entry flex justify-between px-3 py-2 rounded-lg font-semibold text-red-700 transition"><span>3. Dashboard <?php echo e($role==='editor'?'Editor':'Admin'); ?> ⚙️</span></a>
        ...
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <a href="#sec-verify" class="toc-entry flex justify-between px-3 py-2 rounded-lg text-gray-700 transition"><span><?php echo e($isAdmin ? '4' : '5'); ?>. Verifikasi Keaslian Dokumen</span></a>
    </div>
</div>
...
<div id="sec-overview" class="bg-white rounded-2xl shadow-sm border border-gray-100 px-8 py-7 mb-6">
    ...
    <p class="text-gray-600 text-sm leading-relaxed mb-5">
        <strong><?php echo e($siteName); ?></strong> adalah platform manajemen prosiding konferensi ilmiah yang mengelola seluruh proses mulai dari pendaftaran peserta, pengiriman dan review paper, pembayaran registrasi, hingga penerbitan sertifikat dan prosiding digital.
    </p>
    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div class="bg-blue-50 border border-blue-100 rounded-xl p-4 text-center <?php echo e($isAuthor ? 'ring-2 ring-blue-400' : ''); ?>">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isAuthor): ?><p class="text-xs font-bold text-blue-700 mt-1">← Peran Anda</p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        <div class="bg-teal-50 border border-teal-100 rounded-xl p-4 text-center <?php echo e($isPart ? 'ring-2 ring-teal-400' : ''); ?>">
            <div class="text-2xl mb-1">🎟️</div>
            <p class="text-sm font-bold text-teal-800">Peserta</p>
            <p class="text-xs text-teal-600 mt-1">Daftar & akses materi konferensi</p>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPart): ?><p class="text-xs font-bold text-teal-700 mt-1">← Peran Anda</p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        <div class="bg-indigo-50 border border-indigo-100 rounded-xl p-4 text-center <?php echo e($isRev ? 'ring-2 ring-indigo-400' : ''); ?>">
            <div class="text-2xl mb-1">🔍</div>
            <p class="text-sm font-bold text-indigo-800">Reviewer</p>
            <p class="text-xs text-indigo-600 mt-1">Menilai paper yang masuk</p>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isRev): ?><p class="text-xs font-bold text-indigo-700 mt-1">← Peran Anda</p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        <div class="bg-red-50 border border-red-100 rounded-xl p-4 text-center <?php echo e($isAdmin ? 'ring-2 ring-red-400' : ''); ?>">
            <div class="text-2xl mb-1">⚙️</div>
            <p class="text-sm font-bold text-red-800">Admin / Editor</p>
            <p class="text-xs text-red-600 mt-1">Mengelola seluruh sistem</p>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isAdmin): ?><p class="text-xs font-bold text-red-700 mt-1">← Peran Anda</p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
    <div class="mt-5 bg-yellow-50 border border-yellow-200 rounded-xl p-4">
        <p class="text-sm text-yellow-800"><strong>URL Sistem:</strong> <a href="<?php echo e(url('/')); ?>" class="text-blue-600 underline"><?php echo e(url('/')); ?></a></p>
        <p class="text-sm text-yellow-800 mt-1"><strong>Halaman Login:</strong> <a href="<?php echo e(url('/login')); ?>" class="text-blue-600 underline"><?php echo e(url('/login')); ?></a></p>
        <p class="text-sm text-yellow-800 mt-1"><strong>Halaman Daftar:</strong> <a href="<?php echo e(url('/register')); ?>" class="text-blue-600 underline"><?php echo e(url('/register')); ?></a></p>
    </div>
</div>
...
<div id="sec-register" class="bg-white rounded-2xl shadow-sm border border-gray-100 px-8 py-7 mb-6">
    ...
    <div class="space-y-3 mb-6">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isRev || $isAdmin): ?>
        <div class="mt-2 bg-indigo-50 border border-indigo-200 rounded-xl p-3 text-xs text-indigo-800"><strong>ℹ️ Catatan untuk <?php echo e($rc['label']); ?>:</strong> Akun Anda (<?php echo e(Auth::user()->email); ?>) telah dibuat oleh Admin. Segera ganti password bawaan melalui menu <strong>Edit Profile → Ganti Password</strong>.</div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="space-y-3 mb-5">
        <div class="flex gap-3 items-start"><div class="step-num bg-blue-600 text-white mt-0.5">1</div><p class="text-sm text-gray-700 leading-relaxed pt-1">Kunjungi <a href="<?php echo e(url('/login')); ?>" class="text-blue-600 underline"><?php echo e(url('/login')); ?></a>.</p></div>
...
<div id="sec-verify" class="bg-white rounded-2xl shadow-sm border border-gray-100 px-8 py-7 mb-10">
    <div class="flex items-center gap-3 mb-5">
        <span class="w-9 h-9 bg-gray-700 text-white rounded-xl flex items-center justify-center font-black text-lg"><?php echo e($isAdmin ? '4' : '5'); ?></span>
    ...
    <div class="grid md:grid-cols-2 gap-4">
        ...
        <div class="border border-gray-200 rounded-xl p-4">
            ...
            <div class="space-y-2">
                <div class="flex gap-2 items-start text-xs text-gray-600"><span class="font-bold text-blue-600">✓</span> Sertifikat: <code class="bg-gray-100 px-1 rounded"><?php echo e(url('/')); ?>/verify-certificate/[NOMOR]</code></div>
                <div class="flex gap-2 items-start text-xs text-gray-600"><span class="font-bold text-blue-600">✓</span> LOA: <code class="bg-gray-100 px-1 rounded"><?php echo e(url('/')); ?>/verify-loa/[KODE]</code></div>
...
<div class="text-center text-xs text-gray-400 mb-6">
    <p>Buku Panduan <?php echo e($siteName); ?> — <?php echo e($rc['emoji']); ?> <?php echo e($rc['label']); ?> — Dicetak <?php echo e(now()->isoFormat('D MMMM Y')); ?></p>
    <p class="mt-1"><?php echo e(url('/')); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isAdmin): ?> | Untuk pertanyaan teknis, gunakan fitur Helpdesk di dalam sistem.<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></p>
</div>

</div>
</body>
</html>
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views/manual.blade.php ENDPATH**/ ?>
    ...
    <section id="about" class="py-20 bg-gray-50/60">
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div>
                    <span class="inline-block bg-teal-100 text-teal-700 text-xs font-bold px-3 py-1.5 rounded-full mb-5 uppercase tracking-wider"><?php echo e(__('welcome.conference.badge')); ?></span>
                    <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900 mb-3 leading-tight"><?php echo e($activeConference->name); ?></h2>
                    ...
                    <p class="text-lg text-teal-600 font-medium italic mb-6">"<?php echo e($activeConference->theme); ?>"</p>
                    ...
                    <div class="text-gray-600 leading-relaxed mb-8"><?php echo nl2br(e($activeConference->description)); ?></div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="space-y-3 mb-8">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-xs text-gray-400 font-medium uppercase"><?php echo e(__('welcome.conference.tanggal')); ?></p>
                                <p class="text-sm font-bold text-gray-800"><?php echo e($activeConference->start_date->translatedFormat('d F Y')); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeConference->end_date && $activeConference->end_date->ne($activeConference->start_date)): ?> — <?php echo e($activeConference->end_date->translatedFormat('d F Y')); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></p>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-xs text-gray-400 font-medium uppercase"><?php echo e(__('welcome.conference.lokasi')); ?></p>
                                <p class="text-sm font-bold text-gray-800">
                                    <?php echo e($activeConference->venue_type_label); ?>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-xs text-gray-400 font-medium uppercase"><?php echo e(__('welcome.conference.penyelenggara')); ?></p>
                    ...
                    <div>
                        <h3 class="text-xs font-bold text-gray-800 uppercase tracking-wider mb-3"><?php echo e(__('welcome.conference.topik_bidang')); ?></h3>
                        <div class="flex flex-wrap gap-2">
                            ...
                            <span class="text-sm bg-white text-teal-700 px-3 py-1.5 rounded-full border border-teal-200 font-medium"><?php echo e($topic->name); ?></span>
                ...
                <div class="sticky top-24">
                    <?php $posterImage = $activeConference->cover_image ?? $activeConference->brochure; ?>
                    ...
                    <div class="rounded-2xl overflow-hidden shadow-xl border border-gray-200 bg-white mb-6" x-data="{ lightbox: false }">
                        <div class="relative cursor-pointer group" @click="lightbox = true">
                            <img src="<?php echo e(asset('storage/' . $posterImage)); ?>" alt="<?php echo e($activeConference->name); ?>" class="w-full h-auto">
                        ...
                        <div x-show="lightbox" x-cloak x-transition @click="lightbox = false" @keydown.escape.window="lightbox = false"
                            ...
                            <img src="<?php echo e(asset('storage/' . $posterImage)); ?>" alt="<?php echo e($activeConference->name); ?>" class="max-w-full max-h-[90vh] object-contain rounded-xl shadow-2xl" @click.stop>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border p-6 text-center">
                        ...
                        <img src="<?php echo e(asset('storage/' . $activeConference->logo)); ?>" alt="Logo" class="h-16 mx-auto mb-4 object-contain">
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <p class="text-gray-500 text-sm mb-5"><?php echo e(__('welcome.conference.info_kegiatan')); ?></p>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/dashboard')); ?>" class="block w-full bg-teal-600 text-white py-3 rounded-full font-semibold hover:bg-teal-700 transition shadow-sm">Submit Paper</a>
                        <?php else: ?>
                            <a href="<?php echo e(route('register')); ?>" class="block w-full bg-teal-600 text-white py-3 rounded-full font-semibold hover:bg-teal-700 transition shadow-sm">Submit Paper</a>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
            </div>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\templates\ijo-muhammadiyah\sections\about.blade.php ENDPATH**/ ?>
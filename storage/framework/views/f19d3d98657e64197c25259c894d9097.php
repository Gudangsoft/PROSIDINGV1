<div class="py-6 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <div class="bg-white rounded-xl shadow-sm p-4 border text-center">
            <p class="text-2xl font-bold text-gray-700"><?php echo e($counts['total']); ?></p>
            <p class="text-xs text-gray-500 mt-1">Total Tiket</p>
        </div>
        <div class="bg-white rounded-xl shadow-sm p-4 border text-center">
            <p class="text-2xl font-bold text-yellow-600"><?php echo e($counts['open']); ?></p>
            <p class="text-xs text-gray-500 mt-1">Open</p>
        </div>
        <div class="bg-white rounded-xl shadow-sm p-4 border text-center">
            <p class="text-2xl font-bold text-blue-600"><?php echo e($counts['in_progress']); ?></p>
            <p class="text-xs text-gray-500 mt-1">Diproses</p>
        </div>
        <div class="bg-white rounded-xl shadow-sm p-4 border text-center">
            <p class="text-2xl font-bold text-green-600"><?php echo e($counts['resolved']); ?></p>
    ...
    <div class="flex flex-col sm:flex-row gap-3 mb-4">
        ...
        <select wire:model.live="categoryFilter" class="border-gray-300 rounded-lg shadow-sm text-sm focus:ring-blue-500 focus:border-blue-500">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = \App\Models\HelpdeskTicket::CATEGORIES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <option value="<?php echo e($val); ?>"><?php echo e($label); ?></option>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </select>
        <select wire:model.live="priorityFilter" class="border-gray-300 rounded-lg shadow-sm text-sm focus:ring-blue-500 focus:border-blue-500">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = \App\Models\HelpdeskTicket::PRIORITIES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <option value="<?php echo e($val); ?>"><?php echo e($label); ?></option>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </select>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border overflow-hidden">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3 text-gray-500">#<?php echo e($ticket->id); ?></td>
                        <td class="px-4 py-3">
                            <a href="<?php echo e(route('admin.helpdesk.detail', $ticket)); ?>" class="text-blue-600 hover:underline font-medium"><?php echo e(Str::limit($ticket->subject, 40)); ?></a>
                        </td>
                        <td class="px-4 py-3 text-gray-700"><?php echo e($ticket->user->name); ?></td>
                        <td class="px-4 py-3">
                            <span class="text-xs text-gray-600"><?php echo e($ticket->category_label); ?></span>
                        </td>
                        <td class="px-4 py-3">
                            <span class="inline-flex items-center gap-1">
                                <span class="w-2 h-2 rounded-full bg-<?php echo e($ticket->priority_color); ?>-500"></span>
                                <span class="text-xs"><?php echo e($ticket->priority_label); ?></span>
                            </span>
                        </td>
                        <td class="px-4 py-3">
                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-<?php echo e($ticket->status_color); ?>-100 text-<?php echo e($ticket->status_color); ?>-700">
                                <?php echo e($ticket->status_label); ?>

                            </span>
                        </td>
                        <td class="px-4 py-3 text-center text-gray-500"><?php echo e($ticket->replies_count); ?></td>
                        <td class="px-4 py-3 text-xs text-gray-500"><?php echo e($ticket->created_at->format('d M Y')); ?></td>
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-2">
                                <a href="<?php echo e(route('admin.helpdesk.detail', $ticket)); ?>" class="text-blue-500 hover:text-blue-700" title="Detail">
                                ...
                                <button wire:click="updateStatus(<?php echo e($ticket->id); ?>, 'in_progress')" class="text-indigo-500 hover:text-indigo-700" title="Proses">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                </button>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($ticket->status, ['open', 'in_progress'])): ?>
                                <button wire:click="updateStatus(<?php echo e($ticket->id); ?>, 'resolved')" class="text-green-500 hover:text-green-700" title="Selesaikan">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                </button>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <button wire:click="delete(<?php echo e($ticket->id); ?>)" wire:confirm="Hapus tiket ini?" class="text-red-500 hover:text-red-700" title="Hapus">
        ...
        <div class="px-4 py-3 border-t"><?php echo e($tickets->links()); ?></div>
        <?php else: ?>
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\livewire\admin\helpdesk-management.blade.php ENDPATH**/ ?>
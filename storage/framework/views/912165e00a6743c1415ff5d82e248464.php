...
<head>
    ...
    ?>
    <title><?php echo e($page->meta_title ?: $page->title); ?> — <?php echo e($siteName); ?></title>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($page->meta_description): ?>
    <meta name="description" content="<?php echo e($page->meta_description); ?>">
    <?php elseif($page->excerpt): ?>
    <meta name="description" content="<?php echo e($page->excerpt); ?>">
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <meta property="og:type" content="article">
    <meta property="og:title" content="<?php echo e($page->meta_title ?: $page->title); ?>">
    <meta property="og:description" content="<?php echo e($page->meta_description ?: $page->excerpt ?: Str::limit(strip_tags($page->content), 160)); ?>">
    ...
    <meta property="og:image" content="<?php echo e(asset('storage/' . $page->cover_image)); ?>">
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="<?php echo e(route('dashboard')); ?>" class="text-sm text-blue-600 hover:text-blue-800 font-semibold transition px-3 py-1.5 rounded-lg hover:bg-blue-50">Dashboard</a>
                    <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-600 hover:text-blue-700 px-3 py-2 font-medium transition">Login</a>
                    <a href="<?php echo e(route('register')); ?>" class="text-sm bg-blue-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-blue-700 transition">Daftar</a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($page->layout !== 'blank'): ?>
    ...
    <header class="relative overflow-hidden" style="background: linear-gradient(135deg, var(--theme-hero-bg, #1e40af), var(--theme-secondary-color, #4f46e5));">
        ...
        <div class="absolute inset-0">
            <img src="<?php echo e(asset('storage/' . $page->cover_image)); ?>" alt="" class="w-full h-full object-cover opacity-20">
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
            <h1 class="text-3xl md:text-4xl font-bold text-white mb-3"><?php echo e($page->title); ?></h1>
            ...
            <p class="text-lg text-white/80 max-w-2xl mx-auto"><?php echo e($page->excerpt); ?></p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </header>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <main class="py-12">
        <div class="<?php echo e($page->layout === 'narrow' ? 'max-w-3xl' : ($page->layout === 'sidebar' ? 'max-w-7xl' : 'max-w-5xl')); ?> mx-auto px-4 sm:px-6 lg:px-8">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($page->layout === 'sidebar'): ?>
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <aside class="space-y-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($relatedPages->isNotEmpty()): ?>
                    <div class="bg-white rounded-xl shadow-sm border p-5">
                        ...
                        <ul class="space-y-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $relatedPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <li>
                                <a href="<?php echo e(route('page.show', $rp->slug)); ?>"
                                   class="text-sm text-gray-600 hover:text-blue-600 transition flex items-center gap-2 <?php echo e($rp->id === $page->id ? 'text-blue-600 font-semibold' : ''); ?>">
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\templates\dark-elegant\page.blade.php ENDPATH**/ ?>
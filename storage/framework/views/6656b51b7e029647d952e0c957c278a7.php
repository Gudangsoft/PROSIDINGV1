...
<body class="bg-gray-50 min-h-screen font-sans antialiased text-gray-700">
    ...
    <div class="bg-white border-b">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 py-3">
            <div class="flex items-center gap-2 text-sm text-gray-400">
                ...
                <span class="text-gray-600"><?php echo e($page->title); ?></span>
            </div>
        </div>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="relative overflow-hidden" style="background: linear-gradient(135deg, var(--theme-hero-bg, #0f766e), var(--theme-secondary-color, #059669));">
        ...
        <div class="absolute inset-0">
            <img src="<?php echo e(asset('storage/' . $page->cover_image)); ?>" alt="" class="w-full h-full object-cover opacity-15">
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <div class="relative max-w-6xl mx-auto px-4 sm:px-6 py-14 text-center">
            <h1 class="text-3xl md:text-4xl font-extrabold text-white mb-3 leading-tight"><?php echo e($page->title); ?></h1>
            ...
            <p class="text-base text-white/75 max-w-2xl mx-auto"><?php echo e($page->excerpt); ?></p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <section class="max-w-6xl mx-auto px-4 sm:px-6 py-10">
                ...
                <div class="bg-white rounded-xl border p-5 shadow-sm">
                    ...
                    <div class="space-y-2">
                        ...
                        <a href="<?php echo e(route('page.show', $rp->slug)); ?>"
                           class="group flex items-center gap-2 p-2 rounded-lg hover:bg-teal-50/60 transition text-sm <?php echo e($rp->id === $page->id ? 'text-teal-700 font-semibold bg-teal-50/40' : 'text-gray-600'); ?>">
                            <svg class="w-3 h-3 shrink-0 <?php echo e($rp->id === $page->id ? 'text-teal-500' : 'text-gray-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                            <?php echo e($rp->title); ?>
        ...
        <?php else: ?>
        <article class="<?php echo e($page->layout === 'narrow' ? 'max-w-3xl mx-auto' : ''); ?>">
            <div class="bg-white rounded-2xl border p-8 md:p-10 shadow-sm">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($page->layout === 'blank'): ?>
                <h1 class="text-2xl md:text-3xl font-extrabold text-gray-900 mb-6 leading-tight"><?php echo e($page->title); ?></h1>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <div class="prose-content">
                    <?php echo $page->content; ?>
    ...
    <footer class="bg-gray-900 text-gray-400 mt-auto">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 py-8 flex flex-col sm:flex-row justify-between items-center text-xs text-gray-500">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($poweredBy): ?><p class="mt-1 sm:mt-0"><?php echo $poweredBy; ?></p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </footer>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\templates\ijo-muhammadiyah\page.blade.php ENDPATH**/ ?>
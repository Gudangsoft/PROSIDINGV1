<div class="py-6 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div class="bg-white rounded-xl border p-4 shadow-sm flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-xl font-bold text-gray-800"><?php echo e($tables->count()); ?></p>
            </div>
        </div>
        <div class="bg-white rounded-xl border p-4 shadow-sm flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-xl font-bold text-gray-800"><?php echo e($totalSize); ?></p>
            </div>
        </div>
        <div class="bg-white rounded-xl border p-4 shadow-sm flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-base font-bold text-gray-800 truncate max-w-[120px]"><?php echo e($dbName); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
        ...
        <div class="bg-white rounded-xl border shadow-sm p-5">
            ...
            <a href="<?php echo e(route('admin.database.export')); ?>"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border overflow-hidden">
        <div class="px-5 py-4 border-b flex items-center justify-between">
            <h2 class="text-base font-semibold text-gray-800">Daftar Tabel (<?php echo e($tables->count()); ?>)</h2>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-4 py-2.5 text-gray-400 text-xs"><?php echo e($i + 1); ?></td>
                        <td class="px-4 py-2.5">
                            <code class="text-xs bg-blue-50 text-blue-700 px-2 py-0.5 rounded font-mono"><?php echo e($table['name']); ?></code>
                        </td>
                        <td class="px-4 py-2.5 text-right text-gray-600 font-mono text-xs"><?php echo e($table['rows']); ?></td>
                        <td class="px-4 py-2.5 text-right text-gray-500 text-xs"><?php echo e($table['size']); ?></td>
                        <td class="px-4 py-2.5 text-center">
                            <span class="text-xs text-gray-500 bg-gray-100 px-2 py-0.5 rounded"><?php echo e($table['engine']); ?></span>
                        </td>
                        <td class="px-4 py-2.5 text-center text-xs text-gray-400">
                            <?php echo e($table['updated'] ? \Carbon\Carbon::parse($table['updated'])->format('d/m/Y h:i A') : '-'); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showImportConfirm): ?>
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\livewire\admin\database-manager.blade.php ENDPATH**/ ?>
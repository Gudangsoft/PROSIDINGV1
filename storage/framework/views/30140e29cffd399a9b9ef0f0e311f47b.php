        ...
        <div class="bg-white rounded-xl shadow-sm border p-6">
            <div class="flex items-start justify-between">
                <div class="flex-1 min-w-0 mr-4">
                    <h3 class="text-lg font-semibold text-gray-800 truncate"><?php echo e($paper->title); ?></h3>
                    <div class="flex items-center gap-3 mt-2 text-sm text-gray-500">
                        <span>Topik: <?php echo e($paper->topic ?? '-'); ?></span>
                        <span>&bull;</span>
                        <span>Diterima: <?php echo e($paper->accepted_at->format('d M Y')); ?></span>
                    </div>
                </div>
                <div class="flex flex-col items-end gap-2">
                    ...
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                        ...
                        <?php elseif($color==='amber' || $color==='yellow'): ?> bg-yellow-100 text-yellow-800
                        <?php elseif($color==='purple'): ?> bg-purple-100 text-purple-800
            ...
            <div class="mt-4 pt-4 border-t border-gray-100 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paper->payment): ?>
                        <div class="text-sm">
                            <p class="text-gray-600">Tagihan: <span class="font-bold text-gray-800"><?php echo e($paper->payment->formatted_amount); ?></span></p>
                            <p class="text-gray-500 text-xs mt-1"><?php echo e($paper->payment->invoice_number); ?></p>
                            ...
                            ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loaBankName || $loaBankAccount): ?>
                            <div class="mt-2 bg-blue-50 border border-blue-100 rounded-lg p-2.5">
                                ...
                                <div class="text-xs space-y-0.5">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loaBankName): ?><p class="text-gray-700">Bank: <span class="font-medium"><?php echo e($loaBankName); ?></span></p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loaBankAccount): ?><p class="text-gray-700">No. Rekening: <span class="font-mono font-bold text-gray-900"><?php echo e($loaBankAccount); ?></span></p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loaAccountHolder): ?><p class="text-gray-700">a.n. <span class="font-medium"><?php echo e($loaAccountHolder); ?></span></p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paper->payment->status === 'pending'): ?>
                                <a href="<?php echo e(route('author.paper.payment', $paper)); ?>" class="inline-flex items-center gap-1 mt-2 text-xs text-white bg-blue-600 hover:bg-blue-700 px-3 py-1.5 rounded font-medium transition">
                                    Upload Bukti Bayar
                                </a>
                            <?php elseif($paper->payment->status === 'uploaded'): ?>
                            ...
                            <?php elseif($paper->payment->status === 'verified'): ?>
                            ...
                            <?php elseif($paper->payment->status === 'rejected'): ?>
                                <span class="inline-flex items-center mt-2 px-2 py-0.5 rounded text-xs font-medium bg-red-100 text-red-800">Ditolak</span>
                                <a href="<?php echo e(route('author.paper.payment', $paper)); ?>" class="inline-flex items-center gap-1 mt-1 text-xs text-red-600 hover:text-red-800 font-medium">
                                    Upload Ulang
                                </a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\livewire\author\loa-list.blade.php ENDPATH**/ ?>
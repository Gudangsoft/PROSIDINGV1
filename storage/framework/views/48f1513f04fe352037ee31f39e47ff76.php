<div class="max-w-5xl mx-auto py-8 px-4">
    ...
    <div class="bg-gradient-to-br from-orange-50 to-amber-50 border border-orange-200 rounded-2xl p-10 text-center">
        ...
        <a href="<?php echo e(route('participant.payment')); ?>" class="inline-flex items-center gap-2 mt-5 px-5 py-2.5 bg-orange-500 text-white rounded-xl text-sm font-semibold hover:bg-orange-600 transition shadow-sm">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($certs->isNotEmpty()): ?>
    <div class="mb-8">
        <div class="flex items-center gap-3 mb-4">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500"><?php echo e($conference->name); ?></p>
            </div>
            <span class="ml-auto bg-amber-100 text-amber-700 text-xs font-bold px-2.5 py-1 rounded-full"><?php echo e($certs->count()); ?> certificate<?php echo e($certs->count() > 1 ? 's' : ''); ?></span>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $certs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                ...
                <div class="mx-3 mt-2 mb-3 border border-yellow-200 rounded-xl p-4 bg-gradient-to-br from-yellow-50/60 to-amber-50/40">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="font-bold text-gray-800 text-sm leading-tight"><?php echo e($cert->title); ?></p>
                            <p class="text-xs text-amber-700 font-medium mt-0.5"><?php echo e($conference->name); ?></p>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cert->description): ?>
                                <p class="text-xs text-gray-500 mt-1"><?php echo e($cert->description); ?></p>
                    ...
                    <div class="flex items-center gap-2 mt-4">
                        <a href="<?php echo e(asset('storage/'.$cert->file_path)); ?>" download="<?php echo e($cert->file_name); ?>"
                        ...
                        <a href="<?php echo e(asset('storage/'.$cert->file_path)); ?>" target="_blank"
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalOther > 0): ?>
    <div class="mb-10">
        <div class="flex items-center gap-3 mb-4">
            ...
            <span class="ml-auto bg-teal-100 text-teal-700 text-xs font-bold px-2.5 py-1 rounded-full"><?php echo e($totalOther); ?> file<?php echo e($totalOther > 1 ? 's' : ''); ?></span>
        </div>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($otherMats->has('ppt')): ?>
        <div class="mb-4">
            <p class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2 pl-1">Presentations (PPT)</p>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $otherMats['ppt']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <div class="bg-white border border-blue-100 rounded-xl p-4 flex items-center gap-3 hover:shadow-sm hover:border-blue-200 transition group">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="font-semibold text-gray-800 text-sm truncate"><?php echo e($mat->title); ?></p>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mat->description): ?><p class="text-xs text-gray-400 truncate"><?php echo e($mat->description); ?></p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mat->file_size): ?><p class="text-xs text-gray-400 mt-0.5"><?php echo e($mat->file_size); ?></p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($otherMats->has('materi')): ?>
        <div class="mb-4">
            <p class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2 pl-1">Materials</p>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $otherMats['materi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($otherMats->has('lainnya')): ?>
        <div class="mb-4">
            <p class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2 pl-1">Others</p>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $otherMats['lainnya']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($certs->isEmpty() && $totalOther === 0): ?>
    <div class="bg-white rounded-2xl border p-10 text-center text-gray-400 mb-8">
        ...
        <p class="text-sm font-medium">No content uploaded yet for <span class="text-gray-600"><?php echo e($conference->name); ?></span></p>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\livewire\participant\material-list.blade.php ENDPATH**/ ?>
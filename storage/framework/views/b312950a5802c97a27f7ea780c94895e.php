...
<head>
    ...
    <title><?php echo e($news->title); ?> — <?php echo e($siteName); ?></title>
    <meta name="description" content="<?php echo e($news->excerpt ?: Str::limit(strip_tags($news->content), 160)); ?>">
    <meta property="og:type" content="article">
    <meta property="og:title" content="<?php echo e($news->title); ?>">
    <meta property="og:description" content="<?php echo e($news->excerpt ?: Str::limit(strip_tags($news->content), 160)); ?>">
    ...
    <meta property="og:image" content="<?php echo e(asset('storage/' . $news->cover_image)); ?>">
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <meta property="article:published_time" content="<?php echo e($news->published_at?->toIso8601String()); ?>">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(url('/')); ?>" class="hidden sm:flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-900 transition font-medium">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                        Beranda
                    </a>
                    <a href="<?php echo e(url('/')); ?>#news" class="flex items-center gap-1.5 text-sm text-blue-600 hover:text-blue-800 font-semibold transition px-3 py-1.5 rounded-lg hover:bg-blue-50">
    ...
    <div class="bg-white border-b">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
            <nav class="flex items-center gap-2 text-sm text-gray-500 overflow-hidden">
                <a href="<?php echo e(url('/')); ?>" class="hover:text-blue-600 transition shrink-0">Beranda</a>
                ...
                <a href="<?php echo e(url('/')); ?>#news" class="hover:text-blue-600 transition shrink-0">Berita</a>
                <svg class="w-3.5 h-3.5 text-gray-300 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                <span class="text-gray-800 font-medium truncate"><?php echo e(Str::limit($news->title, 60)); ?></span>
            </nav>
        </div>
    </div>
            ...
            <article class="flex-1 min-w-0">
                <div class="bg-white rounded-2xl border shadow-sm p-6 sm:p-8 lg:p-10">
                    ...
                    <div class="mb-5">
                        <span class="inline-flex items-center px-3 py-1 text-xs font-bold rounded-full uppercase tracking-wider
                            <?php echo e($news->category === 'general' ? 'bg-blue-100 text-blue-700' : ''); ?>

                            <?php echo e($news->category === 'academic' ? 'bg-purple-100 text-purple-700' : ''); ?>

                            <?php echo e($news->category === 'event' ? 'bg-green-100 text-green-700' : ''); ?>

                            <?php echo e($news->category === 'announcement' ? 'bg-yellow-100 text-yellow-700' : ''); ?>

                            <?php echo e(!in_array($news->category, ['general','academic','event','announcement']) ? 'bg-gray-100 text-gray-700' : ''); ?>">
                            <?php echo e(\App\Models\News::CATEGORY_LABELS[$news->category] ?? $news->category); ?>
                    ...
                    <h1 class="text-2xl sm:text-3xl lg:text-[2.25rem] font-extrabold text-gray-900 leading-tight mb-6"><?php echo e($news->title); ?></h1>
                    ...
                    <div class="flex flex-wrap items-center gap-x-5 gap-y-3 mb-8 pb-6 border-b border-gray-100">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white font-bold text-sm shadow-sm">
                                <?php echo e(strtoupper(substr($news->author->name, 0, 1))); ?>

                            </div>
                            <div>
                                <p class="text-sm font-semibold text-gray-900"><?php echo e($news->author->name); ?></p>
                        ...
                        <div class="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-gray-500">
                            <div class="flex items-center gap-1.5">
                                ...
                                <?php echo e($news->published_at?->translatedFormat('d F Y')); ?>

                            </div>
                            <div class="flex items-center gap-1.5">
                                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                <?php echo e(number_format($news->views_count)); ?> views
                            </div>
                            <?php $readTime = max(1, ceil(str_word_count(strip_tags($news->content)) / 200)); ?>
                            <div class="flex items-center gap-1.5">
                                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                <?php echo e($readTime); ?> menit baca
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8 rounded-xl overflow-hidden">
                        <img src="<?php echo e(asset('storage/' . $news->cover_image)); ?>" alt="<?php echo e($news->title); ?>" class="w-full h-auto object-cover">
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 p-5 rounded-r-xl mb-8">
                        <p class="text-gray-700 font-medium leading-relaxed italic text-[0.9375rem]">"<?php echo e($news->excerpt); ?>"</p>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="mt-6 bg-white rounded-2xl border shadow-sm p-6 lg:hidden">
                    ...
                    <div class="flex items-center gap-2.5 flex-wrap">
                        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(request()->url())); ?>" target="_blank" rel="noopener"
                        ...
                        <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(request()->url())); ?>&text=<?php echo e(urlencode($news->title)); ?>" target="_blank" rel="noopener"
                        ...
                        <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo e(urlencode(request()->url())); ?>&title=<?php echo e(urlencode($news->title)); ?>" target="_blank" rel="noopener"
                        ...
                        <a href="https://wa.me/?text=<?php echo e(urlencode($news->title . ' ' . request()->url())); ?>" target="_blank" rel="noopener"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($relatedNews->count()): ?>
                <div class="mt-8">
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-xl font-bold text-gray-900">Berita Terkait</h3>
                        <a href="<?php echo e(url('/')); ?>#news" class="text-sm font-semibold text-blue-600 hover:text-blue-800 transition flex items-center gap-1">
                            Lihat Semua Berita
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                        </a>
                    </div>
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $relatedNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <a href="<?php echo e(route('news.detail', $related->slug)); ?>" class="group bg-white rounded-xl border shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($related->cover_image): ?>
                            <div class="h-44 overflow-hidden">
                                <img src="<?php echo e(asset('storage/' . $related->cover_image)); ?>" alt="<?php echo e($related->title); ?>" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                            </div>
                            <?php else: ?>
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <div class="p-4">
                                <h4 class="text-sm font-bold text-gray-800 group-hover:text-blue-600 transition line-clamp-2 mb-2"><?php echo e($related->title); ?></h4>
                                <p class="text-xs text-gray-400 flex items-center gap-1">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                    <?php echo e($related->published_at?->diffForHumans()); ?>
            ...
            <aside class="w-full lg:w-80 xl:w-96 shrink-0 space-y-6">
                ...
                <div class="bg-white rounded-xl border shadow-sm p-5">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="font-bold text-gray-900"><?php echo e($news->author->name); ?></p>
                            <p class="text-xs text-gray-400 mt-0.5"><?php echo e($news->author->email); ?></p>
                        </div>
                    </div>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="bg-white rounded-xl border shadow-sm p-5">
                    ...
                    <div class="space-y-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $latestNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $latest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <a href="<?php echo e(route('news.detail', $latest->slug)); ?>" class="flex items-start gap-3 group">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($latest->cover_image): ?>
                            <img src="<?php echo e(asset('storage/' . $latest->cover_image)); ?>" alt="" class="w-16 h-16 rounded-lg object-cover shrink-0 shadow-sm">
                            <?php else: ?>
                            ...
                            <div class="flex-1 min-w-0">
                                <h4 class="text-sm font-semibold text-gray-800 group-hover:text-blue-600 transition line-clamp-2 leading-snug"><?php echo e($latest->title); ?></h4>
                                <p class="text-xs text-gray-400 mt-1.5 flex items-center gap-1">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                    <?php echo e($latest->published_at?->diffForHumans()); ?>
                    ...
                    <a href="<?php echo e(url('/')); ?>#news" class="mt-5 flex items-center justify-center gap-1.5 w-full px-4 py-2.5 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-lg text-sm font-semibold transition">
                        Lihat Semua Berita
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                    </a>
                </div>
    ...
    <footer class="bg-gray-900 text-gray-400 mt-10">
        <div class="border-t border-gray-800">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row justify-between items-center text-sm gap-2">
                ...
                <p class="text-gray-600"><?php echo e($poweredBy); ?></p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
    </footer>
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\templates\dark-elegant\news-detail.blade.php ENDPATH**/ ?>
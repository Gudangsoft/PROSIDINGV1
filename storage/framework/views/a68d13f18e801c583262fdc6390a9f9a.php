    ...
    <nav x-data="{ scrolled: false, mobileOpen: false }"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center gap-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($siteLogo): ?>
                        <img src="<?php echo e((str_starts_with($siteLogo, 'uploads/') ? asset($siteLogo) : asset('storage/' . $siteLogo))); ?>" alt="Logo" class="h-10 w-10 object-contain rounded">
                    <?php else: ?>
            ...
            <div x-show="mobileOpen" x-cloak x-transition class="md:hidden pb-4 border-t space-y-1 pt-2">
                ...
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <a href="<?php echo e(route('tutorial')); ?>" @click="mobileOpen=false" class="block px-3 py-2 text-sm text-gray-600 hover:bg-blue-50 rounded-lg <?php echo e(request()->routeIs('tutorial') ? 'font-semibold text-blue-700' : ''); ?>">Tutorial</a>
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views/templates/default/welcome.blade.php ENDPATH**/ ?>
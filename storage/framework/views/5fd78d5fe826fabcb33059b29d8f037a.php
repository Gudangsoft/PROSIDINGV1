      ...
      <tr>
        <td style="padding:36px 32px;">
          ...
          <p style="margin:0 0 24px;color:#475569;font-size:15px;">
            Password akun Anda di <strong><?php echo e(config('app.name')); ?></strong> telah berhasil diubah.
          </p>
...
<?php /**PATH D:\LPKD-APJI\PROSIDINGV1\resources\views\emails\password-reset.blade.php ENDPATH**/ ?>
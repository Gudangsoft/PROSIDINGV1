...
class Conference extends Model
{
    protected $fillable = [
        ...
        'payment_contact_phone', 'payment_contact_name', 'payment_contacts', 'payment_instructions', 'payment_methods',
    ...
    {
        return $this->hasMany(ParticipantType::class)->orderBy('sort_order');
    }

...
<div class="setup-container">
        ...
        <div class="card-body-custom">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="input-cell" colspan="3">
                                    <input type="text" id="app_name" class="form-control" value="{{ $envValues['app_name'] ?? 'Prosiding Conference' }}" autocomplete="off">
                            ...
                            <tr>
                                ...
                                <td class="input-cell" colspan="3">
                                    <input type="text" id="app_url" class="form-control" value="{{ $envValues['app_url'] ?? '' }}" placeholder="https://conference.domain.com" autocomplete="off">
                            ...
                            <tr>
                                ...
                                <td class="input-cell">
                                    <select id="app_env" class="form-select">
                                        ...
                                        <option value="staging" {{ ($envValues['app_env'] ?? '') == 'staging' ? 'selected' : '' }}>Staging</option>
                                    </select>
                                </td>
                                <td class="label-cell text-end">Debug</td>
                                <td class="input-cell">
                                    <select id="app_debug" class="form-select">
                                        <option value="false" {{ ($envValues['app_debug'] ?? '') == 'false' ? 'selected' : '' }}>Off</option>
                                        <option value="true" {{ ($envValues['app_debug'] ?? '') == 'true' ? 'selected' : '' }}>On</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="input-cell" colspan="3">
                                    <select id="app_timezone" class="form-select">
                                        <option value="Asia/Jakarta" {{ ($envValues['app_timezone'] ?? 'Asia/Jakarta') == 'Asia/Jakarta' ? 'selected' : '' }}>WIB (Jakarta)</option>
                                        <option value="Asia/Makassar" {{ ($envValues['app_timezone'] ?? '') == 'Asia/Makassar' ? 'selected' : '' }}>WITA (Makassar)</option>
                                        <option value="Asia/Jayapura" {{ ($envValues['app_timezone'] ?? '') == 'Asia/Jayapura' ? 'selected' : '' }}>WIT (Jayapura)</option>
                                        <option value="UTC" {{ ($envValues['app_timezone'] ?? '') == 'UTC' ? 'selected' : '' }}>UTC</option>
                                    </select>
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <table class="table table-borderless mb-0 config-table">
                        <tbody>
                            <tr>
                                ...
                                <td class="input-cell">
                                    <input type="text" id="db_host" class="form-control" value="{{ $envValues['db_host'] ?? 'localhost' }}" autocomplete="off">
                                </td>
                                <td class="label-cell text-end">Port</td>
                                <td class="input-cell" style="width: 100px;">
                                    <input type="text" id="db_port" class="form-control" value="{{ $envValues['db_port'] ?? '3306' }}" autocomplete="off">
                                </td>
                            </tr>
                            <tr>
                                <td class="label-cell">Database</td>
                                <td class="input-cell" colspan="3">
                                    <input type="text" id="db_database" class="form-control" value="{{ $envValues['db_database'] ?? '' }}" placeholder="nama_database" autocomplete="off">
                            ...
                            <tr>
                                ...
                                <td class="input-cell" colspan="3">
                                    <input type="text" id="db_username" class="form-control" value="{{ $envValues['db_username'] ?? '' }}" placeholder="root" autocomplete="new-password" data-lpignore="true">
                                </td>
                            </tr>
                            <tr>
                    ...
                    <table class="table table-borderless mb-0 config-table">
                        <tbody>
                            <tr>
                                ...
                                <td class="input-cell" colspan="3">
                                    <select id="mail_mailer" class="form-select" onchange="toggleMailFields()">
                                        <option value="log" {{ ($envValues['mail_mailer'] ?? 'log') == 'log' ? 'selected' : '' }}>Log Only (tidak kirim email)</option>
                                        <option value="smtp" {{ ($envValues['mail_mailer'] ?? '') == 'smtp' ? 'selected' : '' }}>SMTP</option>
                                        <option value="sendmail" {{ ($envValues['mail_mailer'] ?? '') == 'sendmail' ? 'selected' : '' }}>Sendmail</option>
                                    </select>
                            ...
                            <tr id="mailHostRow">
                                ...
                                <td class="input-cell">
                                    <input type="text" id="mail_host" class="form-control" value="{{ $envValues['mail_host'] ?? '' }}" placeholder="mail.domain.com" autocomplete="off">
                                </td>
                                <td class="label-cell text-end">Port</td>
                                <td class="input-cell" style="width: 100px;">
                                    <input type="text" id="mail_port" class="form-control" value="{{ $envValues['mail_port'] ?? '587' }}" autocomplete="off">
                                </td>
                            </tr>
                            <tr id="mailUserRow">
                                <td class="label-cell">Username</td>
                                <td class="input-cell" colspan="3">
                                    <input type="text" id="mail_username" class="form-control" value="{{ $envValues['mail_username'] ?? '' }}" placeholder="email@domain.com" autocomplete="new-password" data-lpignore="true">
                                </td>
                            </tr>
                            <tr id="mailPassRow">
                                <td class="label-cell">Password</td>
                            ...
                            <tr id="mailFromRow">
                                ...
                                <td class="input-cell" colspan="3">
                                    <input type="email" id="mail_from_address" class="form-control" value="{{ $envValues['mail_from_address'] ?? '' }}" placeholder="noreply@domain.com" autocomplete="off">
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div id="step5" class="d-none">
                <div class="success-animation">
                    ...
                    <a href="{{ url('/') }}" class="btn btn-primary-custom" style="min-width: 200px;">
                        <i class="bi bi-house"></i>
                        Buka Aplikasi
                    </a>
    ...
    <div class="setup-footer">
        Laravel {{ app()->version() }} &bull; PHP {{ PHP_VERSION }} &bull; 
...
async function doCreateAdmin() {
    ...
    const data = await post('{{ route("setup.create-admin") }}', { name, email, password });

        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <a href="{{ url('/') }}" class="flex items-center gap-3 group">
                    @if($siteLogo)
                    <img src="{{ (str_starts_with($siteLogo, 'uploads/') ? asset($siteLogo) : asset('storage/' . $siteLogo)) }}" alt="Logo" class="h-9 w-9 object-contain rounded-lg">
                    @else
    ...
    <footer class="bg-gray-900 text-gray-400">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                <div class="flex items-center gap-3">
                    @if($siteLogo)
                    <img src="{{ (str_starts_with($siteLogo, 'uploads/') ? asset($siteLogo) : asset('storage/' . $siteLogo)) }}" alt="Logo" class="h-8 object-contain opacity-80">
                    @endif

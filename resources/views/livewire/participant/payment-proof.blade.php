    ...
    <div class="bg-white rounded-xl shadow-sm border overflow-hidden">
        ...
        <div class="p-6">
            ...
            <form wire:submit="reupload" class="space-y-5">
                ...
                @else
                <div class="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-4 text-amber-800">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="font-semibold text-sm">Informasi Rekening Belum Tersedia</p>
                            <p class="text-xs mt-1">Silakan hubungi panitia untuk informasi rekening pembayaran karena belum diatur oleh admin pada sistem.</p>
                        </div>
                    </div>
                </div>
                @endif

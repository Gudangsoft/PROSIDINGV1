<div class="max-w-4xl mx-auto py-8 px-4">
    ...
    <div class="bg-white rounded-xl shadow-sm border overflow-hidden mb-6">
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 text-sm">
                ...
                <div class="flex items-center gap-2 text-gray-600">
                    ...
                    <span class="inline-flex items-center gap-1.5">
                        <span class="px-1.5 py-0.5 rounded text-xs font-medium {{ \App\Models\Conference::VENUE_TYPE_COLORS[$conference->venue_type ?? 'offline'] ?? '' }}">{{ $conference->venue_type_label }}</span>
                        @if($conference->venue_type !== 'online')
                ...
                <div class="flex items-center gap-2 text-gray-600">
                    ...
                    <a href="{{ $conference->online_url }}" target="_blank" class="text-blue-600 hover:text-blue-800 hover:underline font-medium">
                        Link Zoom Meeting
                    </a>
                </div>
                @endif
            ...
            {{-- WhatsApp Group Link --}}
            @if($payment && $payment->status === 'verified' && $conference->wa_group_non_pemakalah)
            <div class="mt-5 pt-4 border-t">
                <h4 class="text-sm font-semibold text-gray-700 mb-3">Grup WhatsApp Peserta</h4>
                <a href="{{ $conference->wa_group_non_pemakalah }}" target="_blank" class="inline-flex items-center gap-2 px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg text-sm font-medium transition">

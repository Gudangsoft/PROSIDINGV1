<div class="py-6 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
    {{-- Back Button --}}
    <a href="{{ route('admin.helpdesk') }}" class="inline-flex items-center text-sm text-gray-500 hover:text-gray-700 mb-4">
    ...
    <div class="bg-white rounded-xl shadow-sm border p-6 mb-6">
        <div class="flex items-start justify-between mb-4">
            <div>
                <h1 class="text-xl font-bold text-gray-800">#{{ $ticket->id }} — {{ $ticket->subject }}</h1>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm bg-gray-50 rounded-lg p-4 mb-4">
            ...
            <div>
                ...
                <p class="font-medium text-gray-800">{{ ucfirst($ticket->user->role) }}</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p class="font-medium text-gray-800">{{ $ticket->assignee?->name ?? '-' }}</p>
            </div>
        </div>
            ...
            <div class="flex items-center gap-2 mb-2">
                ...
                <div>
                    <p class="text-sm font-medium text-gray-800">
                        ...
                        <span class="text-xs bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded ml-1">{{ ucfirst($reply->user->role) }}</span>
                        @endif
                    </p>

        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl text-white p-5">
            <div class="flex items-start justify-between gap-4">
                ...
                <div class="flex items-center gap-3 shrink-0">
                    ...
                    {{-- Cleanup duplicate participant certs for authors --}}
                    <button wire:click="cleanupDuplicateCertificates"
                            wire:confirm="Hapus sertifikat peserta yang dimiliki pemakalah (duplikat)? Aksi ini tidak dapat dibatalkan."
                            wire:loading.attr="disabled"
                            class="flex items-center gap-2 px-5 py-2.5 bg-red-100 text-red-800 rounded-lg text-sm font-semibold hover:bg-red-200 transition disabled:opacity-60">
                        <span wire:loading.remove wire:target="cleanupDuplicateCertificates">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
                        </span>
                        <span wire:loading wire:target="cleanupDuplicateCertificates">
                            <svg class="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" class="opacity-25"/><path d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" fill="currentColor" class="opacity-75"/></svg>
                        </span>
                        <span wire:loading.remove wire:target="cleanupDuplicateCertificates">Bersihkan Duplikat</span>
                        <span wire:loading wire:target="cleanupDuplicateCertificates">Membersihkan...</span>
                    </button>
                </div>
            </div>
        </div>
